...
void* CocoaCreateButton(void* window, int x, int y, int width, int height, const char *text, void* ptr) {
  NSAutoreleasePool *pool = [[NSAutoreleasePool alloc] init];
	...
	if (newButton != nil) {
		...
		/* [zach] another style: 
		[newButton setButtonType: NSMomentaryLightButton];
		[newButton setBezelStyle: NSRoundedBezelStyle]; // NSRoundedBezelStyle, NSTexturedRoundedBezelStyle, NSRecessedBezelStyle, 
